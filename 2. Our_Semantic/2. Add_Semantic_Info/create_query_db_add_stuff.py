...
# database_file = "/home/ubuntu/cw/Hierarchical-Localization/datasets/outputs/DB/bag_query_ver3_stuff.db"
database_file = "/home/ubuntu/cw/Hierarchical-Localization/datasets/outputs/DB/300ms_query_oneformer.db"
...
for image_file in image_files:
    ...
    for sem_seg_val in np.unique(sem_seg):
        ...
        if category_id is None or category_id not in class_mapping:
            continue  # Skip if the category_id is not in our class_mapping
        segment_field = {
            'counts': counts,
